...
<?php $__env->startSection('subheading', 'Masukkan email akun untuk menerima kode verifikasi reset password'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('password.email')); ?>" id="forgotPasswordForm" class="space-y-6">
        <?php echo csrf_field(); ?>
    ...
    <div class="mt-10 text-center">
        <a href="<?php echo e(route('login')); ?>" class="text-xs font-bold text-lib-500 hover:text-lib-800 transition-colors flex items-center justify-center gap-2">
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Downloads\laravel\perpustakaan sekolah\perpus\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>