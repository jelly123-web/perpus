...
<?php $__env->startSection('subheading', 'silahkan login dulu!'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('login.authenticate')); ?>" class="login-page-form space-y-5" data-async-auth="true" data-loading-label="Masuk...">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center justify-between gap-3">
            <label class="flex items-center gap-2.5 cursor-pointer">
                <input type="checkbox" class="checkbox-lib" name="remember" value="1" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                <span class="text-xs text-slate-500">Ingat saya</span>
            </label>
            <a href="<?php echo e(route('password.request')); ?>" class="text-xs font-semibold text-orange-500 hover:text-orange-600 transition-colors">Forgot password?</a>
        </div>
    ...
    <div class="social-grid">
        ...
        <a
            href="<?php echo e(route('auth.google.redirect')); ?>"
            class="auth-icon-link inline-flex items-center justify-center gap-2 border border-slate-200 bg-white text-slate-800 transition hover:border-slate-300 hover:bg-slate-50"
    ...
    <p class="text-center mt-8 text-sm text-slate-500">
        Belum punya akun?
        <a href="<?php echo e(route('register')); ?>" class="auth-link">Daftar sekarang</a>
    </p>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Downloads\laravel\perpustakaan sekolah\perpus\resources\views\auth\login.blade.php ENDPATH**/ ?>