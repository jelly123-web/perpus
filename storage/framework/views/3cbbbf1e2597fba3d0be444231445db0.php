...
<?php $__env->startSection('subheading'); ?>
    ...
    <span class="font-semibold text-lib-900 mt-1 inline-block"><?php echo e(session('reset_email')); ?></span>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <style>
        :root {
            --accent: <?php echo e(\App\Models\Setting::valueOr('app_color', '#c4956a')); ?>;
            --accent-glow: <?php echo e(\App\Models\Setting::valueOr('app_color', '#c4956a')); ?>33;
        }
    ...
    <form method="POST" action="<?php echo e(route('password.verify_code.post')); ?>" id="verifyForm">
        <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                <p class="text-[11px] text-red-500 mt-4 text-center font-semibold bg-red-50 py-2 rounded-lg border border-red-100 animate-pulse"><?php echo e($message); ?></p>
            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mt-12 pt-8 border-t border-lib-100/50">
        ...
        <div class="space-y-3">
            <form id="resendForm" action="<?php echo e(route('password.email')); ?>" method="POST" class="block w-full">
                <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(route('password.request')); ?>" class="action-link text-xs w-full justify-center opacity-60 hover:opacity-100">
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Downloads\laravel\perpustakaan sekolah\perpus\resources\views\auth\verify-code.blade.php ENDPATH**/ ?>