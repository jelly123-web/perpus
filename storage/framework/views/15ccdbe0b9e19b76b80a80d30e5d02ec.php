<?php $__env->startSection('title', 'Cari Buku dengan Foto'); ?>
...
<div class="member-page">
    <div class="member-toolbar">
        ...
        <a href="<?php echo e(route('admin.books.index')); ?>" class="member-badge" style="background:var(--bg-card);color:var(--fg);border:1px solid var(--border-light);text-decoration:none;">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function renderResults(data) {
            ...
            books.forEach(function (book) {
                ...
                html += '<div>';
                html += '<a href="<?php echo e(route('admin.books.index')); ?>" class="image-result-link">Lihat di daftar buku</a>';
                html += '</div>';
                html += '</div>';
                html += '</article>';
            });
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Downloads\laravel\perpustakaan sekolah\perpus\resources\views\admin\books\search-by-image.blade.php ENDPATH**/ ?>