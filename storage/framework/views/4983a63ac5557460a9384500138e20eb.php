...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('login.authenticate')); ?>" class="space-y-5" data-async-auth="true" data-loading-label="Masuk...">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-lib-500 hover:text-lib-700 transition-colors">Forgot password?</a>
        </div>
