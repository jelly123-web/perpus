...
<style>
    ...
    .profile-card,.profile-form{background:#fff;border:1px solid var(--dbx-border, #e2e8f0);border-radius:12px;box-shadow:none}
    .profile-card{padding:24px}
    .profile-form{padding:24px}
    .profile-title{font-size:20px;font-weight:700;color:var(--dbx-text, #1e293b)}
    .profile-sub{font-size:13px;color:var(--dbx-text-muted, #64748b);line-height:1.6;margin-top:4px}
    .profile-photo{width:120px;height:120px;border-radius:16px;overflow:hidden;background:var(--dbx-primary-light, #fff7ed);display:flex;align-items:center;justify-content:center;color:var(--dbx-primary, #f97316);font-size:40px;font-weight:800;margin:20px auto 0;position:relative;border:2px solid var(--dbx-border, #e2e8f0);box-shadow:none}
    .profile-photo img{width:100%;height:100%;object-fit:cover}
    .profile-photo.is-editable{cursor:pointer;position:relative}
    .profile-photo.is-editable::after{content:'Ubah';position:absolute;bottom:0;left:0;right:0;background:rgba(0,0,0,.6);color:#fff;font-size:11px;font-weight:600;text-align:center;padding:4px 0;opacity:0;transition:opacity .2s}
    .profile-photo.is-editable:hover::after{opacity:1}
    .profile-meta{display:grid;gap:12px;margin-top:24px}
    .profile-box{background:#f8fafc;border:1px solid var(--dbx-border, #e2e8f0);border-radius:8px;padding:12px 16px}
    .profile-box-label{font-size:11px;font-weight:600;color:#94a3b8;text-transform:uppercase}
    .profile-box-value{font-size:14px;font-weight:600;margin-top:4px;color:var(--dbx-text, #1e293b);line-height:1.5}
    .profile-form-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px}
    .profile-upload{position:relative;margin-top:16px;padding:20px;border:2px dashed rgba(249,115,22,.3);border-radius:12px;background:#fffbf5}
    .profile-upload input[type="file"]{display:none}
    .profile-upload-head{display:flex;align-items:center;gap:16px;margin-bottom:16px}
    .profile-upload-icon{width:48px;height:48px;border-radius:12px;background:var(--dbx-primary-light, #fff7ed);display:flex;align-items:center;justify-content:center;color:var(--dbx-primary, #f97316);flex-shrink:0}
    .profile-upload-title{font-size:15px;font-weight:700;color:var(--fg)}
    .profile-upload-sub{font-size:12px;color:var(--dbx-text-muted, #64748b);line-height:1.6;margin-top:4px}
    .profile-upload-actions{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:16px}
    .profile-upload-btn{display:flex;align-items:center;justify-content:center;gap:8px;padding:10px;border:1px solid var(--dbx-border, #e2e8f0);border-radius:8px;background:#fff;font-size:13px;font-weight:600;cursor:pointer;color:var(--dbx-text, #1e293b);transition:.2s}
    .profile-upload-btn:hover{border-color:var(--dbx-primary, #f97316);color:var(--dbx-primary, #f97316)}
    .profile-upload-name{font-size:12px;color:var(--dbx-text-muted, #64748b);line-height:1.5;margin-top:12px}
    ...
    .profile-upload-preview img{width:100px;height:100px;border-radius:12px;object-fit:cover;border:1px solid var(--dbx-border, #e2e8f0);background:#fff}
    ...
    .profile-hint{font-size:12px;color:var(--dbx-text-muted, #64748b);line-height:1.6;margin-top:10px}
    ...
    .profile-modal-title{font-size:24px;font-weight:700;color:var(--dbx-text, #1e293b)}
    .profile-modal-sub{font-size:13px;color:var(--dbx-text-muted, #64748b);line-height:1.6;margin-top:4px}
...
<div class="member-page">
    <div class="member-toolbar">
        <div>
            ...
            <p class="member-subtitle">Kelola informasi pribadi dan foto profil Anda.</p>
        </div>
        <div class="member-badge" style="background:var(--dbx-primary-light, #fff7ed);color:var(--dbx-primary, #f97316);"><i data-lucide="shield-check" class="w-4 h-4"></i> Akun Pribadi</div>
    </div>

    <div class="profile-shell">
        <aside class="profile-card">
            <div class="profile-title">Akun Aktif</div>
            <div class="profile-sub">Foto dan nama di panel ini akan berubah setelah disimpan.</div>
            ...
            <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data" class="space-y-3 mt-6" data-async="true" data-loading-label="Menyimpan foto..." data-success-call="handleProfileUpdateSuccess">
                ...
                <div class="profile-upload" id="profileUploadRoot">
                    ...
                    <div class="profile-upload-head">
                        ...
                        <div>
                            <div class="profile-upload-title">Ganti Foto Profil</div>
                            <div class="profile-upload-sub">Upload foto baru atau ambil dari kamera.</div>
                        </div>
                    </div>
                    <div class="profile-upload-actions">
                        <button type="button" class="profile-upload-btn js-profile-open-camera"><i data-lucide="camera" class="w-4 h-4"></i> Kamera</button>
                        <button type="button" class="profile-upload-btn js-profile-open-gallery"><i data-lucide="image" class="w-4 h-4"></i> Galeri</button>
                    </div>
                ...
                <button type="submit" class="btn-primary rounded-xl px-4 py-3 text-sm font-semibold" style="width:100%;justify-content:center;margin-top:24px;">
