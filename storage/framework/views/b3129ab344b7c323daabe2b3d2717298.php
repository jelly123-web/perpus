...
<div class="setting-page">
    ...
    <div class="setting-shell">
        <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" enctype="multipart/form-data" class="setting-card setting-card-main js-setting-form">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>

            <div class="setting-field">
                <label class="setting-label" for="app_name">Nama Aplikasi</label>
                <input id="app_name" name="app_name" class="form-input px-3 py-3 text-sm" value="<?php echo e(old('app_name', $appName)); ?>" required>
            </div>

            <div class="setting-field">
                <label class="setting-label" for="app_name_color">Warna Nama Aplikasi</label>
                <div class="flex items-center gap-3">
                    <input id="app_name_color" name="app_name_color" type="color" class="h-12 w-14 rounded-xl border border-[var(--border)] bg-white p-1" value="<?php echo e(old('app_name_color', $appNameColor)); ?>" required>
                    <input id="app_name_color_text" type="text" class="form-input px-3 py-3 text-sm uppercase tracking-[0.12em] font-mono" value="<?php echo e(old('app_name_color', $appNameColor)); ?>" maxlength="7" pattern="^#[0-9A-Fa-f]{6}$" inputmode="text">
                </div>
            ...
            <div class="setting-field">
                <div class="setting-toggle">
                    ...
                    <label class="setting-switch" for="show_app_name">
                        <input id="show_app_name" name="show_app_name" type="checkbox" value="1" <?php echo e(old('show_app_name', $showAppName ? '1' : null) ? 'checked' : ''); ?>>
            ...
            <div class="setting-field">
                ...
                <input id="discord_webhook_url" name="discord_webhook_url" class="form-input px-3 py-3 text-sm" value="<?php echo e(old('discord_webhook_url', $settings['discord_webhook_url']->value ?? '')); ?>" placeholder="https://discord.com/api/webhooks/...">
        ...
        <div class="setting-card setting-preview">
            <div class="setting-preview-shell">
                <div class="setting-brand">
                    <div class="setting-brand-logo<?php echo e($appLogo ? ' has-image' : ''); ?>" id="settingBrandLogo">
                        <?php if($appLogo): ?>
                            <img id="settingPreviewLogo" src="<?php echo e(asset($appLogo)); ?>" alt="<?php echo e($appName); ?>">
                        <?php else: ?>
                            <i id="settingPreviewIcon" data-lucide="book-open" style="width:26px;height:26px;color:#7A5A28;"></i>
                            <img id="settingPreviewLogo" src="" alt="<?php echo e($appName); ?>" style="display:none;">
                        <?php endif; ?>
                    </div>
                    <div id="settingPreviewNameWrap" style="<?php echo e(old('show_app_name', $showAppName ? '1' : null) ? '' : 'display:none;'); ?>">
                        <div id="settingPreviewName" class="setting-brand-name" style="color: <?php echo e($appNameColor); ?>"><?php echo e(old('app_name', $appName)); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('admin.settings._autosave-script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Downloads\laravel\perpustakaan sekolah\perpus\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>