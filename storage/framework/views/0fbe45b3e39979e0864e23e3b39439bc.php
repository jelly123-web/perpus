...
<?php $__env->startSection('subheading', 'Silakan buat password baru untuk mengamankan akun Anda'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('password.update')); ?>" class="space-y-6" id="resetPasswordForm">
        <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                <p class="text-[11px] text-red-500 mt-2 ml-1 font-medium"><?php echo e($message); ?></p>
            <?php unset($message);
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Downloads\laravel\perpustakaan sekolah\perpus\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>