...
<body>
    ...
    <nav class="navbar">
        <a href="<?php echo e(route('dashboard')); ?>" class="logo">
            ...
            <span class="logo-text"><?php echo e($appName); ?></span>
        </a>
    </nav>
    ...
    <main class="main-content">
        <div class="error-container">
                ...
                <div class="floating-books">
                    ...
                    <div class="book-item" style="--rot: -15deg;">
                        <svg class="book-svg" viewBox="0 0 50 70" fill="none">
                            ...
                            <rect x="10" y="10" width="30" height="4" rx="1" fill="<?php echo e($appColor); ?>"/>
            ...
            <div class="action-buttons">
                <a href="<?php echo e(route('login')); ?>" class="btn-glow">
    ...
    <!-- Footer -->
    <footer class="footer">
        <p><?php echo e($appName); ?> &copy; <?php echo e(date('Y')); ?></p>
    </footer>
</body>
</html><?php /**PATH C:\Users\HP\Downloads\laravel\perpustakaan sekolah\perpus\resources\views\errors\404.blade.php ENDPATH**/ ?>